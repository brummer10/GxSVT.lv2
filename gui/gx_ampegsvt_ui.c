...
static void ref_value_changed(GtkAdjustment *adj, gpointer* args) {
    ...
    gx_ampegsvtUI* ui = (gx_ampegsvtUI*)arg->ui;
...
static LV2UI_Handle instantiate(const LV2UI_Descriptor*   descriptor,
    ...
    *widget = NULL;
    ...
    set_expose_func(GX_AMPEGSVT_PAINT_BOX(ui->pbox),"pedal_expose");
    ui->box = gtk_vbox_new(FALSE, 0);
    ui->hbox = gtk_hbox_new(TRUE, 10);
    gtk_container_set_border_width(GTK_CONTAINER(ui->pbox),35);
    gtk_container_set_border_width(GTK_CONTAINER(ui->hbox),0);
    ui->vbox = gtk_vbox_new(TRUE, 0);

    gtk_box_pack_start(GTK_BOX(ui->pbox), ui->box, TRUE, TRUE, 0);
    gtk_box_pack_start(GTK_BOX(ui->box), ui->hbox, TRUE, TRUE, 0);
    ...
    gtk_box_pack_start(GTK_BOX(ui->bp_box), ui->logo, FALSE, FALSE, 0);
    ...
    ui->adj[4] = gtk_adjustment_new( 1.0, 0.0, 2.0, 1.0, 0.01*10.0, 0);
    ui->knob[4] = gtk_select_new_with_adjustment(GTK_ADJUSTMENT(ui->adj[4]));
    ui->label[4] = gtk_label_new("LOW");
    ...
    ui->args[4]->ui = ui;
    ui->args[4]->port_index = (int)LOWSWITCH;
    ...
    ui->label[1] = gtk_label_new("MIDDLE");
    ...
    ui->args[1]->ui = ui;
    ui->args[1]->port_index = (int)MIDDLE;
    ...
    ui->adj[3] = gtk_adjustment_new( 0.2, 0.0, 1.0, 0.01, 0.01*10.0, 0);
